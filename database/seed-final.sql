-- ============================================
-- Script FINAL - Insertar datos mock
-- ============================================
-- Ejecutar en Supabase SQL Editor

-- Usuario: cassieluc@gmail.com
...
-- Insertar Marketplace Items
INSERT INTO marketplace_items (
    author_id, title, description, category, price, 
...
-- Insertar Events
INSERT INTO events (
    author_id, title, description, event_type, 
...
UNION ALL
SELECT 'Marketplace insertados:', COUNT(*) FROM marketplace_items
UNION ALL
SELECT 'Events insertados:', COUNT(*) FROM events;
