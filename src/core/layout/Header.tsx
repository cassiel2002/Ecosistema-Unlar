      ...
      <header className="sticky top-0 z-30 bg-gray-950/80 backdrop-blur-md border-b border-gray-800">
        <div className="flex items-center justify-between h-16 px-4 md:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              disabled
              className="relative p-2 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-lg text-gray-500 opacity-50 cursor-not-allowed"
              aria-label="Notificaciones (Próximamente)"
              title="Notificaciones (Próximamente)"
            >
              <Bell className="h-5 w-5" />
              {unreadCount > 0 && (
                <span className="absolute top-1 right-1 bg-primary-500/50 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center">
